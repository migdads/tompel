...
function LOGO() {
 ...
 â”€â”€â”€â”‚    $Greenâ”´ â”´â””â”€â”˜ â”´ â””â”€â”˜â””â”€â”˜â””â”€â”˜â”´â””â”€â”´â”´   â”´   â”´â”€â”˜â”´ â”´ â””â”€â”˜$NC   â”‚â”€â”€â”€
    â”‚    ${YELLOW}Copyright${FONT} (C)$GRAY https://github.com/migdads$NC     â”‚
...
#echo -e "       Â© Recode By MyridTunnel Project ${BLUE}(${NC} 2023 ${BLUE})${NC}"
#echo -e "${RED}â—‡â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â—‡${NC}"
#echo ""
#sleep 3
##
echo -e  "${REDBG}â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”${NC}"
echo -e  "${REDBG}â”‚              INPUT YOUR NAME             â”‚${NC}"
echo -e  "${REDBG}â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜${NC}"
echo " "
...
function print_success() {
    if [[ 0 -eq $? ]]; then
        echo -e "${tyblue}â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”${NC}"
        echo -e "${tyblue}â”‚ ðŸŒ¿ $1 BERHASIL DIPASANG ${NC}"
        echo -e "${tyblue}â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜${NC}"
        sleep 2
    fi
}
...
echo -e "${tyblue}â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜${NC}"
echo -e "${tyblue}â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”${NC}"
echo -e "${tyblue}â”‚  [ 1 ]  \033[1;37mGunakan Domain Sendiri/Domainmu       ${NC}"
echo -e "${tyblue}â”‚  "                                        
echo -e "${tyblue}â”‚  [ 2 ]  \033[1;37mGunakan Domain Dari SC (myridtunnel.my.id)     ${NC}"
echo -e "${tyblue}â”‚     "                                     
echo -e "${tyblue}â”‚  [ 3 ]  \033[1;37mGunakan Domain Dari SC (xpro.biz.id)     ${NC}"
echo -e "${tyblue}â”‚     "                                     
echo -e "${tyblue}â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜${NC}"
...
wget -O /usr/sbin/ftvpn "https://github.com/migdads/tompel//ws/ftvpn" >/dev/null 2>&1
...
pth="\033[1;37m"
clear
echo -e "${tyblue} â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”\033[0m"
echo -e "${tyblue} â”‚${pth}            \033[0;36mPORT SERVICE INFO\033[0m             ${tyblue}|\033[0m"
echo -e "${tyblue} â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜\033[0m"
echo -e "${tyblue}â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”"
echo -e "${tyblue}â”‚${pth}       >>> Service & Port                    ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - Open SSH                : 443, 80, 22   ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - Dropbear                : 443, 109, 143 ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - Dropbear Websocket      : 443, 109      ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - SSH Websocket SSL       : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - SSH Websocket           : 80            ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - OpenVPN SSL             : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - OpenVPN Websocket SSL   : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - OpenVPN TCP             : 443, 1194     ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - OpenVPN UDP             : 2200          ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - Nginx Webserver         : 443, 80, 81   ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - Haproxy Loadbalancer    : 443, 80       ${tyblue}â”‚${NC}"
#echo -e "${tyblue}â”‚${pth}   - DNS Server              : 443, 53,      ${tyblue}â”‚${NC}"
#echo -e "${tyblue}â”‚${pth}   - DNS Client              : 443, 88       ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - OpenVPN Websocket SSL   : 443           ${tyblue}â”‚${NC}"
#echo -e "${tyblue}â”‚${pth}   - XRAY DNS (SLOWDNS)      : 443, 53       ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - XRAY Vmess TLS          : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - XRAY Vmess gRPC         : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - XRAY Vmess None TLS     : 80            ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - XRAY Vless TLS          : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - XRAY Vless gRPC         : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - XRAY Vless None TLS     : 80            ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - Trojan gRPC             : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - Trojan WS               : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - Shadowsocks WS          : 443           ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - BadVPN 1                : 7100          ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - BadVPN 2                : 7200          ${tyblue}â”‚${NC}"
echo -e "${tyblue}â”‚${pth}   - BadVPN 3                : 7300          ${tyblue}â”‚${NC}"
#echo -e "${tyblue}â”‚${pth}   - Proxy Squid             : 3128          ${tyblue}â”‚${NC}"
echo -e "${tyblue}â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜"
echo ""
